<div id="help-template" class="outer">
    <h1 class="head">Help:
        <a class="ui-corner-all tooltip" href="<{$xoops_url}>/modules/article/admin/index.php"
           title="Back to the administration of Article"> Article
            <img src="<{xoAdminIcons home.png}>"
                 alt="Back to the Administration of Article">
        </a></h1>

    <h4 class="odd">DESCRIPTION</h4>

    <p class="even">This module is Article Management.<br> <br>
    </p>
