...
define($GLOBALS['ART_VAR_PREFIXU'] . '_LANG_EN_ADMIN', 1);
...
define($GLOBALS['ART_VAR_PREFIXU'] . '_AM_PERMISSION_DESC', 'Available category permissions: '
