...
<{* $xoTheme->addStylesheet("modules/$xoops_dirname/assets/css/style_archive.css") *}>
...
<div class="article-section archive-header">
    <h2 class="article-title">
        <a href="<{$xoops_url}>/modules/<{$xoops_dirname}>/view.archive.php<{$smarty.const.URL_DELIMITER}><{$time.year}>/<{$time.month}>/<{$time.day}>/"><{$page.title}>
            : <{$page.time}></a>
        <{if $category}>
            |
        ...
        <div class="article-section-container archive-months" style="padding: 10px;">
            <div class="article-list">
                ...
                <div>
                    ...
                    <{if $num_column != 0 && $smarty.foreach.month.iteration % $num_column eq 0}>
                </div>
                <div class="clear"></div>
                <br style="clear: both;">
                <div>
        ...
        <div class="article-section-container archive-categories" style="padding: 10px;">
            <div class="article-list">
                ...
                <div>
                    ...
                    <{if $num_column != 0 && $smarty.foreach.cat.iteration % $num_column eq 0}>
                </div>
                <div class="clear"></div>
                <br style="clear: both;">
                <div>
