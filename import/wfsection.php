...
$sql = '   INSERT INTO ' . art_DB_prefix('artcat') . '       (art_id,    cat_id,     uid,    ac_register,    ac_publish)' . '   SELECT ' . '       articleid,  categoryid, uid,    created,        created' . '   FROM ' . $GLOBALS['xoopsDB']->prefix('wfs_article') . '       ORDER BY articleid ASC';
...
$sql = '   INSERT INTO '
       ...
       . '   FROM '
       . $GLOBALS['xoopsDB']->prefix('wfs_votedata')
